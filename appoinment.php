    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Забронируйте свое место</span>
          <h1 class="text-capitalize mb-5 text-lg">Запись для всех</h1>
    ...
    <div class="row">
      <div class="col-lg-4">
          <div class="mt-3">
            <div class="feature-icon mb-3">
             ...
             <span class="h3">Вызовите экстренную службу!</span>
      ...
      <div class="col-lg-8">
           <div class="appoinment-wrap mt-5 mt-lg-0 pl-lg-5">
            <h2 class="mb-2 title-color">Запишитесь на прием</h2>
            <p class="mb-4"></p>
               <form id="#" class="appoinment-form" method="POST" action="/app/record.php">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                         ...
                         <div class="col-lg-6">
                            <div class="form-group">
                                <input name="name" id="name" type="text" class="form-control" required  placeholder="Ф.И.О">
                            </div>
                        </div>
						<div class="col-lg-6">
                            <div class="form-group">
                                <input name="doctor" id="doctor" type="text" class="form-control" required  placeholder="Name Doctor">
                            </div>
                        </div>
                    ...
                    <div class="form-group-2 mb-4">
                        <textarea name="desc" id="desc" class="form-control" rows="6" required  placeholder="Ваше сообщение"></textarea>
                    </div>
					<button type="submit" name="do_signup" class="btn btn-main btn-round-full">Запись на прием</button>
                </form>
            </div>
        </div>
      </div>
