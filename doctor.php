...
<? 
			if($_SESSION['admin'] == true){
				...
				echo '<a class="css-modal-open" align="center" href="#worker-add">Добавить пациента</a>';
			} 
		?>
...
<div class="dm-overlay" id="worker-add">
    <div class="dm-table">
        <div class="dm-cell">
            <div class="dm-modal">
                <a href="#close" class="close">X</a>
				<form action="/app/admin.php" method="POST"> 
						...
						<input type="text" name="id_cm" placeholder="Введите ID врача" required value=""><br>
						<input type="text" name="id_user" placeholder="Введите ID пользователя" required value=""><br>
						<button type="submit" class="registerbtn">Добавить пациента</button>
